...
class AuthService:
    ...
    def __init__(self, repo: AccRepository, credentials: HTTPAuthorizationCredentials | None = None):
        self.repo = repo
    ...
    async def autenticate_acc(self, email: str, password: str) -> Account | bool:
    ...
    def create_access_token(self, data: dict, exp_time: timedelta = None) -> str:
